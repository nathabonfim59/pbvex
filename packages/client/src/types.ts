...
export type IsOptionalArgs<T> = IsAny<T> extends true
  ? false
  : [T] extends [undefined | void]
    ...
    : T extends EmptyObject
      ...
      : {} extends T
        ? true
        : false;
export type OptionalArgs<Args, Options> = IsOptionalArgs<Args> extends true
  ? [args?: Args, options?: Options]
  : [args: Args, options?: Options];

export type ArgsOf<T> = T extends FunctionReference<any, infer Args, any, any>
  ? Args
  : never;

export type ReturnOf<T> = T extends FunctionReference<any, any, infer Return, any>
  ? Return
  : never;
