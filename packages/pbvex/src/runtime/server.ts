...
export interface ActionCtx<DataModel extends GenericDataModel = GenericDataModel> extends FunctionContext<DataModel> {
  auth: AuthContext;
  db?: never;
  scheduler: SchedulerContext;
  storage: StorageContext;
...
export interface HttpActionCtx<DataModel extends GenericDataModel = GenericDataModel> extends ActionCtx<DataModel> {}
