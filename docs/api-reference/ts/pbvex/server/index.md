...
- [MigrationContext](interfaces/MigrationContext.md)
- [MigrationDefinition](interfaces/MigrationDefinition.md)
...
- [defineMigration](functions/defineMigration.md)
...
- [isMigrationDefinition](functions/isMigrationDefinition.md)
