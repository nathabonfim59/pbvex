...
> **action**: \<`Returns`\>(`options`) => [`FunctionDefinition`](../interfaces/FunctionDefinition.md)\<`Record`\<`string`, `never`\>, `Returns`, `ComponentCtx`\<`C`, [`ActionCtx`](../interfaces/ActionCtx.md)\<[`GenericDataModel`](../type-aliases/GenericDataModel.md), `string`\>\>\>
...
[`FunctionOptions`](../interfaces/FunctionOptions.md)\<`Record`\<`string`, `never`\>, `Returns`, `ComponentCtx`\<`C`, [`ActionCtx`](../interfaces/ActionCtx.md)\<[`GenericDataModel`](../type-aliases/GenericDataModel.md), `string`\>\>\>

#### Returns

[`FunctionDefinition`](../interfaces/FunctionDefinition.md)\<`Record`\<`string`, `never`\>, `Returns`, `ComponentCtx`\<`C`, [`ActionCtx`](../interfaces/ActionCtx.md)\<[`GenericDataModel`](../type-aliases/GenericDataModel.md), `string`\>\>\>

### internalAction

> **internalAction**: \<`Returns`\>(`options`) => [`FunctionDefinition`](../interfaces/FunctionDefinition.md)\<`Record`\<`string`, `never`\>, `Returns`, `ComponentCtx`\<`C`, [`ActionCtx`](../interfaces/ActionCtx.md)\<[`GenericDataModel`](../type-aliases/GenericDataModel.md), `string`\>\>\>
