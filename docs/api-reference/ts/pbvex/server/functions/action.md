[pbvex](../../index.md) / [server](../index.md) / action

# Function: action()

> **action**\<`Args`, `Returns`, `DataModel`\>(`options`): [`ActionDef`](../interfaces/ActionDef.md)\<`Args`, `Returns`, [`ActionCtx`](../interfaces/ActionCtx.md)\<`DataModel`\>\>
