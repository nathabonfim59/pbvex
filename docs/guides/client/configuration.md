...
```ts
import { Client, type ClientOptions } from '@pbvex/sdk-core';
...
- `maxUploadBytes` is accepted for forward compatibility but is not enforced by `@pbvex/sdk-core`; storage uploads use a URL generated by a server-side mutation or action (see [Storage](../storage.md)).
