...
These guides cover the browser-neutral `@pbvex/client` client. For framework bindings, see the [React guides](../react/index.md) and [Svelte guides](../svelte/index.md).
...
- Running the backend is covered in the [self-hosting guide](../../self-hosting.md).
