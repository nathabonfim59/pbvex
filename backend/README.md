...
PBVex v1 is a single-process system. Do not run multiple instances against the
same data directory or assume distributed scheduler/realtime coordination.

For deployment and production configuration, see
[the operator guide](../docs/operator.md).
